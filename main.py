...
st.markdown("Напомню, что к **:blue[романским языкам]** относятся **:red[французский, итальянский, "
            "испанский, португальский, румынский, молдавский, каталанский, провансальский,]** "
